...
public class Limit {
    ...
    private void emptyLimit() throws IOException {
    ...
    @Test(groups = {"edge", "limit", "broken"})
    private void notNumberLimit() throws IOException {
        Map<String, String> query = new HashMap<>();
        query.put("q", "apollo");
        query.put("api_key", Utils.apiKey);
        query.put("limit", "aaa");
    ...
    private void zeroLimit() throws IOException {
        Map<String, String> query = new HashMap<>();
        query.put("q", "apollo");
        query.put("api_key", Utils.apiKey);
        query.put("limit", "0");
    ...
    @Test(groups = {"edge", "limit", "broken"})
    private void negativeIntegerLimit() throws IOException {
        Map<String, String> query = new HashMap<>();
        query.put("q", "apollo");
        query.put("api_key", Utils.apiKey);
        query.put("limit", "-5");
    ...
    @Test(groups = {"edge", "limit", "broken"})
    private void biggerThenMaxIntegerLimit() throws IOException {
        Map<String, String> query = new HashMap<>();
        query.put("q", "apollo");
        query.put("api_key", Utils.apiKey);
    ...
    @Test(groups = {"edge", "limit", "broken"})
    private void smallerThenMinIntegerLimit() throws IOException {
        Map<String, String> query = new HashMap<>();
        query.put("q", "apollo");
        query.put("api_key", Utils.apiKey);
